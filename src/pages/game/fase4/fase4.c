...
void fase4(void) {
    ...
    characterCards[2] = create_character_card("../src/assets/images/todd_perfil.png", 1473, 720);
    characterCards[3] = create_character_card("../src/assets/images/todd_mini.png", 1498, 576);
