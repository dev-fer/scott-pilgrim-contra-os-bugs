...
void fase2(void) {
    ...
    characterCards[2] = create_character_card("../src/assets/images/lucaslee_perfil.png", 1473, 720);
    characterCards[3] = create_character_card("../src/assets/images/lucaslee_mini.png", 1498, 576);
